function initHandTouchSection() {
  ...
  function getBrideSizeAdjust() {
    return 0.9;
  }

  function setCharScale(groomScale, brideScale) {
    groomImg.style.transform = `scale(${groomScale})`;
    brideImg.style.transform = `scale(${brideScale})`;
  }
  ...
  function measureTouchOffsets() {
    ...
    setCharScale(1, getBrideSizeAdjust());
  ...
  function onScrollFrame() {
    ...
    const brideAdjust = getBrideSizeAdjust();
    setCharScale(scale, scale * brideAdjust);
